/* Demo rxwtitle.rex */
   ...
   say "Press enter to change the window title"
   pull
   old_title = new_title("Hello world")
   if old_title = '' then do
      say "Program rxwtitle.exe not found"
      exit
   end
   say "Old title was" old_title
   say "new title is" cur_title()
   say "Press enter to reset original title"
   pull
   old_title = new_title(old_title)
exit

/* rxwtitle.rex included here */
/********************************************************************/
/*                                                                  */
/* RXWTITLE, Version 1.0                                            */
